...
words2 = words.group_by { |element| element.downcase.chars.sort }.values
...
# Now I have to figure out how to sort this to show which key has the most anagrams. TO GOOGLE!

words2.max_by { |x| x.length }

# Fixed problems and random ooglings:
###!!!###
